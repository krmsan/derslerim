...
public class C06_ThrowKeyword {
    ...
    public static void main(String[] args) {
        ...
        if (yas<=0){//eger try catch kullanmadan trow new yaparsak code calısmayı durdurur

            try {
                throw new IllegalArgumentException();//sadece bu satırı yazarsak if te calısmayı durdurur
