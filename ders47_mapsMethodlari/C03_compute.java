...
public class C03_compute {
    public static void main(String[] args) {
        ...
        mp1.putIfAbsent("F",14);//olmayanı yaparken put daha mantıklı computeıf ile aynı oluyor usttteki
        ...
        mp1.compute("t", (k,v)-> v=359);
        System.out.println(mp1); //{A=0, R=3, B=6, C=10, t=359, D=11, E=12, F=42}
