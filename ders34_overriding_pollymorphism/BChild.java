...
public class BChild extends AParent {
    ...
    public void method2(int a){
        ...
        // metot ismi, parametre sayısı ve parametr data turu
    ...
    public void method2(String isim){
        ...
        //yukarıdaki ile overloading olmus (int ve string)
    }
    ...
    @Override //parentteki metodda degisiklik olursa cte verir
    public void benim(int a) {
        //super.benim(a);
    }
}
