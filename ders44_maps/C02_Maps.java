...
public class C02_Maps {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, String> ogrenciMap= MapDepo2.ornekMapOlustur();
        ...
        System.out.println(MapDepo2.isimSoyisimDondur(ogrenciMap,108)); // Hikmet Han
        ...
        int ogrenciKey=105;
        String yeniSube="N";
        ogrenciMap= MapDepo2.ogrenciyeYeniSubeAta(ogrenciMap,ogrenciKey,yeniSube);
        System.out.println(ogrenciMap);
    }
}
